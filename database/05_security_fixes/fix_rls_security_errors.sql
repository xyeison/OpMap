-- Script para corregir errores de seguridad RLS en Supabase
-- Fecha: 2025-01-07
...
-- Crear políticas de solo lectura para tablas de referencia
...
-- Políticas para hospital_contracts (ya deberían existir, pero por si acaso)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- ============================================
-- 3. TABLA ESPECIAL: spatial_ref_sys (PostGIS)
-- ============================================
-- Esta tabla es del sistema PostGIS, generalmente no necesita RLS
-- pero si Supabase lo requiere:
ALTER TABLE public.spatial_ref_sys ENABLE ROW LEVEL SECURITY;

-- Permitir acceso público de lectura (es data de referencia geográfica)

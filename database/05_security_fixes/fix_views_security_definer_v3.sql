-- Script corregido para recrear vistas sin SECURITY DEFINER
-- Versión 3: Corrige el problema con MAX(uuid)

-- ============================================
-- 1. RECREAR VISTA: visit_statistics (sin campos problemáticos)
-- ============================================
...
-- ============================================
-- 3. RECREAR VISTA: territory_statistics (CORREGIDA)
-- ============================================
...
-- Verificar que territory_statistics tiene los campos esperados
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'territory_statistics' 
